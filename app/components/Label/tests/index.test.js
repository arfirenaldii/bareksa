...
describe('<Label />', () => {
  it('should render label orange', () => {
    render(<Label color="orange" label="Canceled" />);

    expect(screen.getByText('Canceled')).toBeInTheDocument();
    expect(screen.getByText('Canceled')).toHaveStyle(
      `background-color: #E69849`,
    );
  });

  it('should render label green', () => {
    render(<Label color="green" label="Completed" />);
  ...
  it('should render label red', () => {
    render(<Label color="red" label="Canceled" />);
  ...
  it('should render label white', () => {
    render(<Label color="white" label="Default" />);
